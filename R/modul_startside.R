#' Modul for startside til Muskelregisterets shiny-applikasjon
#'
#' Samler forside i en fil
#' @export
#'
startside_ui <- function(){
    ...
    div(
      ...
      div(
        ...
        div(
          ...
          h2(
            'Velkommen til Rapporteket - Muskelregisteret 3.2.9', align='center')),
        div(
          ...
          div(
            ...
            div(class = "container", style ="margin-right:(@gutter / 10)" ,
                ...
                h4(tags$b('Datadump '), 'gir mulighet til å laste ned registerets rådata i csv-format.')
            ),
            br(),
            br(),
